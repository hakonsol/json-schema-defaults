(function(root, factory) {
 ...
 'use strict';
   ...
   * @return {Object}
   */
  var defaults = function(schema, definitions, field = 'default') {
      ...
      if (typeof schema[field] !== 'undefined') {
          ...
          return defaults(mergedItem, definitions, field);

      } else if (typeof schema.$ref !== 'undefined') {

          var reference = getLocalRef(schema.$ref, definitions);
          return defaults(reference, definitions, field);
          ...
          for (var key in schema.properties) {
              if (schema.properties.hasOwnProperty(key)) {
                  schema.properties[key] = defaults(schema.properties[key], definitions, field);
          ...
          if (schema.items.constructor === Array) {
              var values = schema.items.map(function (item) {
                  return defaults(item, definitions, field);
              });
          ...
          // object-typed arrays
          var value = defaults(schema.items, definitions, field);
   ...
   * @return {Object}
   */
    return function (schema, definitions, field) {
        ...
        return defaults(cloneJSON(schema), definitions, field);
    };
